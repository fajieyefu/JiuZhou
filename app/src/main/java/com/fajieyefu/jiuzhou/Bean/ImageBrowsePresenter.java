...
public class ImageBrowsePresenter {
    ...
    public void loadImage(){
        ...
        images = (List<FileInfo>) intent.getSerializableExtra("images");
    ...
    public void saveImage(){
        ...
        final String imageUrl = CommonData.LOADFILES+"?fileName="+getPositionImage();
    ...
    public String getPositionImage(){
        return images.get(position).getFilePath();
    }
