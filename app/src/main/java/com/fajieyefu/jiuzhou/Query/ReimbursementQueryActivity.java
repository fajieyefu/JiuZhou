 ...
 */
public class ReimbursementQueryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyInfoAdapter= new ApplyInfoAdapter(ReimbursementQueryActivity.this,R.layout.news_item_first,list);
        titleText= (TextView) findViewById(R.id.title_text);
        titleText.setText("报销记录查询");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ReimbursementQueryActivity.this, ReimbursementQueryDetail.class);
                ...
                if (!TextUtils.isEmpty(info) && !info.equals("fail")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ReimbursementQueryActivity.this, "已经到最后了！", Toast.LENGTH_SHORT).show();
