 ...
 */
public class TravelQueryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(TravelQueryActivity.this, ApplyFeeQueryDetail.class);
                ...
                if (!TextUtils.isEmpty(info) && !info.equals("fail")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(TravelQueryActivity.this, "已经到最后了！", Toast.LENGTH_SHORT).show();
