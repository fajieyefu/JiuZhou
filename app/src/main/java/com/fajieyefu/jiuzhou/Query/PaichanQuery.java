 ...
 */
public class PaichanQuery extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		more.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				final Dialog dialog = new Dialog(PaichanQuery.this);
				View dialog_view = LayoutInflater.from(PaichanQuery.this).inflate(R.layout.more_dialog, null);
				ListView lv = (ListView) dialog_view.findViewById(R.id.more_lv);
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(PaichanQuery.this, android.R.layout.simple_list_item_1, dialog_list);
				...
				lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
						switch (position) {
							case 0:
								if (paichan_flag.equals("1")){
									Intent intent = new Intent(PaichanQuery.this, PaichanInputActivity.class);
									...
									PaichanQuery.this.finish();
								}
//								if (bill_code.equals("C") || bill_code.equals("E") || bill_code.equals("A")) {
//
//								} else {
//									Toast.makeText(PaichanQuery.this, "正在审核不能修改", Toast.LENGTH_SHORT).show();
//								}
								break;
							case 1:
								changePaiChanFlag("C");
...
//		});
	...
	private void changePaiChanFlag(final String flag) {
		new AsyncTask<Void, Void, Boolean>() {
			@Override
			protected Boolean doInBackground(Void... params) {
				String info = WebService.changePaiChanFlag(loan_code, flag);
			...
			protected void onPostExecute(Boolean aBoolean) {
				...
				if (aBoolean) {
					Toast.makeText(PaichanQuery.this, "合同订单处理成功！", Toast.LENGTH_SHORT).show();
					PaichanQuery.this.finish();
				} else {
					Toast.makeText(PaichanQuery.this, "处理数据出现异常", Toast.LENGTH_SHORT).show();
					PaichanQuery.this.finish();
				}
	...
	class MyAsyncTask extends AsyncTask<Void, Void, Integer> {
		...
		protected Integer doInBackground(Void... params) {
			...
			String info = WebService.getPaiChanInfo(loan_code);
			Log.i("PaichanQuery",info);
			try {
				JSONObject jsonObject = new JSONObject(info);
				int code = jsonObject.getInt("code");
				if (code != 0) {
		...
		protected void onPostExecute(Integer integer) {
			...
			switch (integer) {
				case -1:
					Toast.makeText(PaichanQuery.this, "数据解析出现错误", Toast.LENGTH_SHORT).show();
					break;
				case 1:
					Toast.makeText(PaichanQuery.this, msg, Toast.LENGTH_SHORT).show();
					break;
				case 0:
