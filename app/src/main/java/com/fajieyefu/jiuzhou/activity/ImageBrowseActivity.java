...
import com.fajieyefu.jiuzhou.Bean.ImageBrowsePresenter;
import com.fajieyefu.jiuzhou.Bean.ImageBrowseView;
import com.fajieyefu.jiuzhou.Bean.ViewPageAdapter;
...
public class ImageBrowseActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener ,ImageBrowseView {
	...
	@Override
	public void setImageBrowse(List<FileInfo> images, int position) {
	...
	public static void startActivity(Context context, List<FileInfo> images , int position){
